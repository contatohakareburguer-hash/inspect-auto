...
export const CHECKLIST: ChecklistCategoria[] = [
  ...
  },
  {
    ...
    itens: [
      {
        key: "trans_trocas",
        nome: "Trocas de marcha (manual/automático)",
        oQueObservar: "Trocas suaves, sem trancos, ruídos ou demora no engate.",
        exemplo: "Câmbio automático demora a engatar D ou R; manual 'arranha' marchas.",
        consequencia: "Reparo de câmbio é um dos mais caros do veículo.",
        sugestao: "Diagnóstico em especialista antes da compra.",
      },
      {
        key: "trans_embreagem",
        nome: "Embreagem (manual)",
        oQueObservar: "Pedal sem ponto alto demais, sem patinar em subida.",
        exemplo: "RPM sobe e o carro não acelera = disco gasto.",
        consequencia: "Troca de kit de embreagem custa caro.",
        sugestao: "Negociar troca ou abater no preço.",
      },
      {
        key: "trans_oleo_cambio",
        nome: "Óleo do câmbio (automático)",
        oQueObservar: "Cor avermelhada e sem cheiro de queimado.",
        exemplo: "Óleo escuro/queimado = câmbio sofrendo.",
        consequencia: "Indica desgaste interno e risco de falha.",
        sugestao: "Trocar fluido conforme manual; revisar se queimado.",
      },
      {
        key: "trans_diferencial",
        nome: "Diferencial / semi-eixos",
        oQueObservar: "Ruídos de zumbido em curvas e estado das coifas.",
        exemplo: "Coifa rasgada do semi-eixo = entrada de sujeira na junta homocinética.",
        consequencia: "Quebra da junta deixa o carro parado.",
        sugestao: "Trocar coifa e graxa; junta se já danificada.",
      },
    ],
  },
  {
    ...
    itens: [
      {
        key: "seg_airbags",
        nome: "Airbags",
        oQueObservar: "Luz de airbag apaga após a partida; tampas sem sinais de abertura.",
        exemplo: "Luz acesa permanente ou tampa do volante mal encaixada.",
        consequencia: "Airbag pode não disparar em colisão.",
        sugestao: "Diagnóstico com scanner; revisar módulo se houve batida.",
      },
      {
        key: "seg_cintos_pretensionadores",
        nome: "Cintos com pré-tensionador",
        oQueObservar: "Cinto recolhe normalmente; sem sinais de disparo anterior.",
        exemplo: "Cinto frouxo que não recolhe = pré-tensionador disparou.",
        consequencia: "Não funciona em nova colisão.",
        sugestao: "Trocar conjunto do cinto.",
      },
      {
        key: "seg_assistencias",
        nome: "Assistências eletrônicas (ESP/ASR/EBD)",
        oQueObservar: "Luzes do painel não ficam acesas; testar em piso seguro.",
        exemplo: "Luz de ESP acesa = sensor de roda ou módulo com falha.",
        consequencia: "Perda de auxílio em manobras de emergência.",
        sugestao: "Diagnóstico eletrônico.",
      },
      {
        key: "seg_buzina_limpadores",
        nome: "Buzina e limpadores",
        oQueObservar: "Buzina firme; palhetas sem riscar o vidro.",
        exemplo: "Palhetas ressecadas embaçam o vidro na chuva.",
        consequencia: "Visibilidade comprometida.",
        sugestao: "Trocar palhetas; revisar buzina.",
      },
    ],
  },
  {
    key: "combustivel_escape",
    nome: "Combustível e Escapamento",
    emoji: "⛽",
    itens: [
      {
        key: "comb_tanque",
        nome: "Tanque e linha de combustível",
        oQueObservar: "Sem cheiro de combustível na cabine ou embaixo do carro.",
        exemplo: "Cheiro forte de gasolina = vazamento na linha.",
        consequencia: "Risco de incêndio.",
        sugestao: "Reparo imediato em oficina.",
      },
      {
        key: "comb_bomba",
        nome: "Bomba de combustível",
        oQueObservar: "Partida rápida, sem ruídos altos do tanque.",
        exemplo: "Zumbido alto vindo do banco traseiro = bomba desgastada.",
        consequencia: "Pode falhar e deixar o carro parado.",
        sugestao: "Substituir bomba.",
      },
      {
        key: "esc_estado",
        nome: "Estado do escapamento",
        oQueObservar: "Sem furos, fixações firmes, catalisador presente.",
        exemplo: "Ruído alto ou cheiro de gases na cabine.",
        consequencia: "Reprovação em vistoria e risco de intoxicação.",
        sugestao: "Reparar/trocar trecho danificado.",
      },
      {
        key: "esc_catalisador",
        nome: "Catalisador",
        oQueObservar: "Presença e estado; carro não fica 'sem força' acima de certa rotação.",
        exemplo: "Catalisador entupido reduz potência drasticamente.",
        consequencia: "Reprova em emissões e perde desempenho.",
        sugestao: "Substituir catalisador original ou homologado.",
      },
    ],
  },
];
